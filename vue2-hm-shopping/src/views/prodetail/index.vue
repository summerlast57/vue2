  ...
  <div class="prodetail">
    ...
    <div class="comment">
      ...
      <div class="comment-list">
        <div class="comment-item" v-for="item in proComments" :key="item.comment_id">
          <div class="top">
...
export default {
  ...
  methods: {
    ...
    async addCart () {
      ...
      const { data } = await addCart(this.goodsId, this.addCount, this.proDetail.skuList[0].goods_sku_id)
